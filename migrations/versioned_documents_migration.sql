...
CREATE TABLE IF NOT EXISTS document_versions (
    ...
    pdf_summary_id UUID REFERENCES pdf_summaries(id) ON DELETE
    SET NULL,
        created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS document_chunks (
    ...
    text TEXT NOT NULL,
    summary TEXT,
    reused_from_chunk_id UUID REFERENCES document_chunks(id) ON DELETE
    SET NULL,
        job_id UUID REFERENCES summary_jobs(id) ON DELETE
    SET NULL,
        created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX IF NOT EXISTS idx_document_chunks_reused ON document_chunks(reused_from_chunk_id)
WHERE reused_from_chunk_id IS NOT NULL;