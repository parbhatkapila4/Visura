...
CREATE INDEX idx_pdf_stores_pdf_summary_id ON pdf_stores(pdf_summary_id);
CREATE INDEX idx_pdf_stores_user_id ON pdf_stores(user_id);
CREATE INDEX idx_pdf_qa_sessions_pdf_store_id ON pdf_qa_sessions(pdf_store_id);
CREATE INDEX idx_pdf_qa_sessions_user_id ON pdf_qa_sessions(user_id);
CREATE INDEX idx_pdf_qa_messages_session_id ON pdf_qa_messages(session_id);
CREATE INDEX idx_pdf_qa_messages_created_at ON pdf_qa_messages(created_at);
...
CREATE VIEW pdf_with_chatbot_support AS
SELECT 
    ps.id,
    ps.user_id,
    ps.title,
...
CREATE VIEW session_with_message_count AS
SELECT 
    qas.id,
    qas.pdf_store_id,
    qas.user_id,
