...
export default function CombinedFeaturedSection() {
  const featuredCaseStudy = {
    ...
    subtitle:
      "without the hassle. Smart extraction, instant search, and AI that answers from your files.",
  };
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-base text-white/50 max-w-2xl mx-auto">
            Summaries, search, and chat, all powered by AI. Visura turns your PDFs and documents
            into answers you can use.
          </p>
        </div>
          ...
          <div className={cn(panelClass, "p-4")}>
            ...
            <h3 className="text-lg font-normal text-white">
              ...
              <span className="font-normal text-gray-400">
                Track uploads, summaries, and sharing across your workspace.
              </span>
            </h3>
...
function SummaryPreview() {
  ...
  return (
    <div className="rounded-lg border border-gray-700 bg-zinc-800/90 flex flex-col p-3 flex-1 min-h-0 relative pr-12 pb-12">
      <span className="text-[10px] font-semibold text-white/70 uppercase tracking-wider mb-2">
        Summary
      </span>
...
function MonitoringChartTooltip({
  ...
  const config: Record<string, string> = {
    desktop: "Documents processed",
    mobile: "Summaries generated",
  };
  return (
        ...
        {payload.map((item) => (
          <div key={item.dataKey} className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-sm text-white/90">{config[item.dataKey] ?? item.dataKey}</span>
            </div>
    ...
    <div className="w-full max-w-sm space-y-2">
      {displayMessages.map((msg, i) => (
        ...
        >
          <div
            className={cn(
              "w-8 h-8 min-w-[2rem] min-h-[2rem] rounded-lg bg-gradient-to-br shrink-0",
              msg.color
            )}
          />
