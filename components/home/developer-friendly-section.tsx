    ...
    <section className="py-20 bg-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-white mb-6">Developer-friendly</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Right out of the box, Visura comes with a comprehensive API, ready for integration into
            your document analysis workflow.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center md:text-left">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-white">&gt; SDK & Libraries</h3>
              ...
              <div className="bg-gray-900 rounded-lg shadow-2xl overflow-hidden">
                ...
                <div className="p-6 font-mono text-sm">
                  <div className="space-y-2">
                    ...
                    <div className="text-gray-500"># Upload and analyze PDF document</div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className="text-green-400">"report.pdf"</span>,{" "}
                    ...
                    <div>)</div>
                    <div className="text-gray-500"># Get AI-generated summary</div>
                    <div>
