...
const steps = [
  {
    ...
    description:
      "Drag and drop any PDF, Word doc, or PowerPoint. Our system handles files up to 50MB with ease.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our advanced AI reads, understands context, and identifies the most important information.",
  ...
  },
  {
    ...
    description:
      "Receive a beautifully formatted summary with key insights, bullet points, and action items.",
  ...
  },
  {
    ...
    description:
      "Have follow-up questions? Chat with your document to get instant, accurate answers.",
...
const StepCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`absolute -top-3 -right-3 w-10 h-10 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white font-bold text-sm`}
        >
          {step.number}
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg text-white/60">
            From upload to insights in under 30 seconds. Here's how our AI transforms your
            documents.
          </p>
        </motion.div>
