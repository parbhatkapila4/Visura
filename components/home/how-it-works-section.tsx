      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              <div className="relative min-h-[500px] border-2 border-gray-800/50 rounded-3xl overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                  {/* Left Side - Subscription Style Cards */}
                  <div className="relative">
                    <div className="relative flex items-center justify-center">
                      ...
                      <motion.div 
                        ...
                        style={{
                          boxShadow: "0 20px 40px rgba(59, 130, 246, 0.3), 0 0 20px rgba(59, 130, 246, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)"
                        }}
                      ...
                      >
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-white/60 text-xs mt-2">visura</div>
                        </div>
                      </motion.div>
                      ...
                      <motion.div 
                        ...
                        style={{
                          boxShadow: "0 25px 50px rgba(0, 0, 0, 0.5), 0 0 30px rgba(139, 92, 246, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1)"
                        }}
                      ...
                      >
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-purple-400/60 text-xs mt-2">visura</div>
                        </div>
                      </motion.div>
                    </div>
                  </div>
