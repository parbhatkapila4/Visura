      ...
      <div className="text-center text-white">
        <div
          className={`text-2xl font-bold ${
            displayText === "SUMMARIZED" ? "text-green-400 animate-pulse" : ""
          }`}
        >
          {displayText}
        </div>
    ...
    <section className="py-20 bg-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-white mb-6">Document Management</h2>
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Easily manage your documents with intuitive controls and quick access to all analysis
            features. Upload, process, and export your documents with just a few clicks.
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-sm text-gray-300">
                Drag and drop PDFs, Word docs, and other formats for analysis
              </p>
            </div>
            ...
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-sm text-gray-300">
                Automatically extract key insights and generate summaries
              </p>
            </div>
            ...
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-sm text-gray-300">
                Download summaries in PDF, Word, or text formats
              </p>
            </div>
            ...
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-sm text-gray-300">
                Share insights with your team via secure links
              </p>
            </div>
          </div>
        </div>
