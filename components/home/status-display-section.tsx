...
function AnimatedAnalytics() {
  ...
  return (
    <div
      className="w-80 h-48 bg-black rounded-2xl shadow-2xl flex items-center justify-center relative overflow-hidden border-2 border-dashed border-orange-500"
      ...
      <div className="text-center relative z-10">
        <div
          className={`text-3xl font-bold mb-2 ${
            displayText === "COMPLETE" ? "text-green-600" : "text-white"
          }`}
        >
          {displayText}
        </div>
    ...
    <section className="py-20 bg-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-white mb-6">Real-time Analytics</h2>
          ...
          <div className="space-y-8 text-center md:text-left">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Track processing speed, accuracy metrics, and document insights in real-time
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Get instant notifications when document analysis is complete and summaries are
                  ready
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  AI-powered analysis extracts key points, summaries, and actionable insights
                  automatically
                </p>
              </div>
            </div>
