    ...
    <section ref={ref} className="relative py-32 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <p className="text-lg md:text-xl text-white/40 mb-8 text-center font-medium">Trusted by professionals at</p>
              ...
              {[
                ...
                <div key={`first-${i}`} className="flex-shrink-0 flex items-center justify-center">
                  <div className="flex flex-col items-center gap-4 group">
                    <div className={`w-24 h-24 md:w-32 md:h-32 rounded-2xl ${company.bgColor} flex items-center justify-center shadow-xl group-hover:scale-110 transition-all duration-300 p-4`}>
                      <company.Logo className="w-full h-full" />
                    </div>
                    <span className="text-white/80 text-base md:text-lg font-semibold whitespace-nowrap">{company.name}</span>
                  </div>
                </div>
              ))}
