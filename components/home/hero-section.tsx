    ...
    >
      ...
      >
        ...
        >
          <Badge
            variant={"secondary"}
            className="px-4 sm:px-6 py-2 text-sm sm:text-base font-medium bg-gray-800 rounded-full flex items-center border border-gray-600"
          >
        ...
        <motion.h2
          ...
          variants={itemVariants}
        >
          Get a sleek summary of your document instantly
        </motion.h2>
