...
// ============================================
// ANIMATED TEXT WITH SPLIT LETTERS
// ============================================
...
// GLOWING BUTTON
// ============================================
const GlowingButton = ({ children, href, primary = false }: { children: React.ReactNode; href: string; primary?: boolean }) => {
  return (
    <Link href={href}>
      <motion.button
      ...
      >
        ...
        <span className={`relative z-10 flex items-center gap-2 ${primary ? 'group-hover:text-white' : ''}`}>
          {children}
          <motion.svg 
            className="w-5 h-5" 
            fill="none" 
        ...
        <div className="sticky top-0 h-screen overflow-hidden bg-black">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-tighter mb-6">
              ...
              <AnimatedText text="that think." className="block bg-gradient-to-r from-[#ff6b00] via-[#ff00ff] to-[#00ff88] bg-clip-text text-transparent" delay={0.8} />
            </h1>
            ...
            >
              Upload any document. Watch AI extract insights, answer questions, 
              and transform how you understand information. In seconds.
            </motion.p>
