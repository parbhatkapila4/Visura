    ...
    <div className="space-y-4">
      {points.map((point, index) => {
        ...
        if (hasEmoji || isMainPoint) {
          ...
          if (isActionItem) {
            cardClasses =
              "group relative bg-gradient-to-br from-green-200/[0.08] to-green-400/[0.03] p-4 rounded-2xl border border-green-500/20 hover:shadow-lg transition-all";
            emojiClasses = "text-lg lg:text-xl shrink-0 pt-1 text-green-500";
          } else if (isWarning) {
            cardClasses =
              "group relative bg-gradient-to-br from-red-200/[0.08] to-red-400/[0.03] p-4 rounded-2xl border border-red-500/20 hover:shadow-lg transition-all";
            emojiClasses = "text-lg lg:text-xl shrink-0 pt-1 text-red-500";
          } else if (isData) {
            cardClasses =
              "group relative bg-gradient-to-br from-blue-200/[0.08] to-blue-400/[0.03] p-4 rounded-2xl border border-blue-500/20 hover:shadow-lg transition-all";
            emojiClasses = "text-lg lg:text-xl shrink-0 pt-1 text-blue-500";
          } else if (isDefinition) {
            cardClasses =
              "group relative bg-gradient-to-br from-purple-200/[0.08] to-purple-400/[0.03] p-4 rounded-2xl border border-purple-500/20 hover:shadow-lg transition-all";
