...
export default function SummaryActions({ summary, variant = "header" }: SummaryActionsProps) {
...
`;
      ...
      link.href = url;
      link.download = `${summary.title || "summary"}-${new Date().toISOString().split("T")[0]}.txt`;
  ...
  const handleShare = async () => {
    try {
      ...
      const shareData = {
        ...
        text: `Check out this AI-generated summary: ${summary.title || "Summary"}`,
        url: shareUrl,
      };
      ...
      <div className="flex gap-2">
        <Link href={`/chatbot/${summary.id}`}>
          <Button
            variant="outline"
            size="sm"
            className="border-rose-600 text-rose-600 hover:bg-rose-50 hover:border-rose-700"
          >
  ...
  return (
    <div className="space-y-3">
      ...
      <Button className="w-full" variant="outline" onClick={handleDownloadSummary}>
        <Download className="w-4 h-4 mr-2" />
        Download Summary
      </Button>
