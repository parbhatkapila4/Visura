    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mx-auto mb-10 max-w-2xl text-center">
        ...
        <p className="text-muted-foreground mt-4 text-sm md:text-base">
          Choose the right plan to unlock powerful tools and insights. Transparent pricing built for
          modern teams.
        </p>
      </div>
        ...
        <div className="flex flex-col justify-between border-b p-6 md:col-span-2 md:border-r md:border-b-0">
          <div className="space-y-4">
            <div>
              ...
              <span className="my-3 block text-3xl font-bold text-purple-600">$0</span>
              <p className="text-muted-foreground text-sm">Best for testing & understanding</p>
            </div>
            ...
            <ul className="text-muted-foreground space-y-3 text-sm">
              {["Basic Analytics Dashboard", "5GB Cloud Storage", "Email & Chat Support"].map(
                (item, index) => (
        ...
        <div className="z-10 grid gap-8 overflow-hidden p-6 md:col-span-4 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-between space-y-6">
            <div>
              ...
              <span className="my-3 block text-3xl font-bold text-purple-600">$299</span>
