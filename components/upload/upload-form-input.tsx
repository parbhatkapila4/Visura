              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4">
                  ...
                  <div className="relative">
                    ...
                    >
                      {selectedFile ? (
                        ...
                        <span className="text-gray-500 text-sm">Select PDF File</span>
                      )}
                    </div>
                  </div>
                </div>
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      <span className="hidden sm:inline">Upload {selectedFile.name}</span>
            ...
            <div className="relative mx-auto max-w-3xl">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-6 sm:p-8 shadow-xl">
                ...
                <div className="mb-4 flex flex-wrap gap-2">
                  {["AI chat", "Instant summary", "PDF support", "Secure"].map((chip) => (
                    <span
                      key={chip}
                      className="text-[11px] tracking-wide uppercase text-white/70 bg-white/5 border border-white/10 rounded-full px-2.5 py-1"
                    >
                      {chip}
                    </span>
                  ))}
                ...
                <div className="space-y-3 relative z-10">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm text-white/85">
                      Text-based PDFs fully support AI chat functionality
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm text-white/70">
                      Scanned documents will be uploaded and summarized, but chat is not available
                    </p>
                  </div>
                </div>
              ...
              <div className="relative mx-auto max-w-3xl px-3 overflow-hidden">
                ...
                <div className="relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 sm:p-8 shadow-xl overflow-hidden">
                  ...
                  <div className="relative w-full h-2 rounded-full bg-white/10 overflow-hidden mb-6">
                    ...
                    <div
                      className="h-full bg-gradient-to-r from-orange-500 via-amber-500 to-red-500 rounded-full transition-all duration-700"
                      style={{ width: "38%" }}
                    />
                  </div>
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3">
                        <div className="relative">
                          ...
                          {i === 0 && (
                            <span className="absolute inset-0 -m-1 rounded-full bg-orange-500/40 blur-sm" />
                          )}
                        </div>
                        ...
                        <span className="hidden sm:block text-xs text-white/70 whitespace-nowrap">
                          {label}
                        </span>
                      </div>
                    ))}
