          ...
          <div className="flex items-center justify-center gap-4">
            <div className="flex-1 max-w-md">
              <div className="relative">
                ...
                />
                <div className={cn(
                  "h-12 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center cursor-pointer hover:border-gray-400 transition-colors",
                  selectedFile && "border-green-400 bg-white",
            ...
            <Button 
              ...
              className="h-12 px-8 bg-green-900 hover:bg-green-800 text-white/80 rounded-lg font-medium"
            >
              {isLoading ? (
                <>
        ...
        <div className="mt-8 space-y-6">
          <div className="text-center">
            ...
            <div className="w-full bg-white/20 rounded-full h-2 mb-6">
              <div className="bg-green-600 h-2 rounded-full animate-pulse" style={{ width: '35%' }}></div>
            </div>
