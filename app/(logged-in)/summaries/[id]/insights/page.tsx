...
import { ProcessingInsightsView } from "@/components/summaries/processing-insights-view";
import type { InsightsResponse } from "@/app/api/documents/[id]/versions/[versionId]/insights/route";
import { Button } from "@/components/ui/button";
import { ChevronLeft } from "lucide-react";

export default async function SummaryInsightsPage(props: { params: Promise<{ id: string }> }) {
