      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 max-w-3xl">
            Choose the perfect plan that fits your document analysis needs. All plans include our core AI-powered 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-gray-600">We support PDF, Word, PowerPoint, Excel, plain text, and image files. Our AI can extract and analyze text from any of these formats.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-sm">
