  ...
  const supportCategories = [
    {
      ...
      title: "My Account",
      description:
        "Manage your account settings, profile information, and personal preferences for document analysis.",
    },
    {
      icon: <CreditCard className="w-8 h-8 text-primary" />,
      title: "Billing & Subscriptions",
      description:
        "View your subscription details, billing history, and manage payment methods for Visura services.",
    },
    {
      icon: <Smartphone className="w-8 h-8 text-primary" />,
      title: "Mobile Access",
      description:
        "Access your document analysis results and manage files on mobile devices and tablets.",
    },
    {
      icon: <Users className="w-8 h-8 text-primary" />,
      title: "Team Collaboration",
      description:
        "Share analysis results, manage team workspaces, and collaborate on document insights.",
    },
    {
      icon: <Settings className="w-8 h-8 text-primary" />,
      title: "Account Settings",
      description:
        "Configure analysis preferences, notification settings, and customize your document processing workflow.",
    },
    {
      icon: <Globe className="w-8 h-8 text-primary" />,
      title: "International Support",
      description:
        "Get help with document analysis in multiple languages and international document formats.",
    },
    {
      icon: <Shield className="w-8 h-8 text-primary" />,
      title: "Security & Privacy",
      description:
        "Learn about document security, data privacy, and how we protect your sensitive information.",
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-primary" />,
      title: "Analytics & Reports",
      description:
        "Understand your analysis results, generate reports, and track document processing performance.",
    },
  ];
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 pt-6 pb-4">
        <div className="w-full">
          ...
          <p className="text-lg sm:text-xl text-zinc-400 max-w-3xl">
            Get help with document analysis, troubleshoot issues, and find answers to your
            questions.
          </p>
        </div>
      </div>
      ...
      <div className="py-12 sm:py-16 relative overflow-hidden">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 text-center relative z-10">
          ...
          <p className="text-base sm:text-lg text-zinc-400 mb-8 max-w-2xl mx-auto">
            Find answers to common questions about document analysis, account management, and
            technical support.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="rounded-xl border border-white/10 bg-zinc-900/80 p-4 hover:bg-zinc-900 transition-colors">
              ...
              <p className="text-sm text-zinc-400">
                Learn how to upload and analyze your first document
              </p>
            </div>
            <div className="rounded-xl border border-white/10 bg-zinc-900/80 p-4 hover:bg-zinc-900 transition-colors">
              <h4 className="font-semibold text-white mb-2">Understanding Analysis Results</h4>
              <p className="text-sm text-zinc-400">
                How to interpret and use your document insights
              </p>
            </div>
            <div className="rounded-xl border border-white/10 bg-zinc-900/80 p-4 hover:bg-zinc-900 transition-colors">
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="rounded-2xl border border-white/10 bg-zinc-900 p-8 max-w-md w-full relative modal-content">
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-400 mb-6">
                This support page is currently under development. We're working hard to bring you
                the best experience.
              </p>
